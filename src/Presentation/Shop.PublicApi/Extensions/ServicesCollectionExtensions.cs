...
internal static class ServicesCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        var healthCheckBuilder = services
            ...
            .AddMongoDb(clientFactory: _ =>
                new MongoClient(options.NoSqlConnection), 
                tags: DbNoSqlTags);
    ...
    public static IServiceCollection AddWriteDbContext(
        this IServiceCollection services, 
        IWebHostEnvironment environment)
    {
        if (!environment.IsEnvironment("Testing"))
        {
            services.AddDbContext<WriteDbContext>((serviceProvider, optionsBuilder) =>
                ConfigureDbContext<WriteDbContext>(serviceProvider, optionsBuilder, 
